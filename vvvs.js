			...
			if (document.querySelector(".landing-main")) {
				...
				if(!document.getElementById("imagesdfgg")){
					document.querySelector(".landing-window").insertAdjacentHTML("afterbegin",
						"<div style='text-align: center;margin-top:12px;position: relative;'><div style='display: flex;align-items: center;justify-content: center;height: 9vw;position: absolute;width: 100%;color: #fff;font-size: 14px;'><img style='width: 16px;margin-right: 5px;' id='imgidfs'>非官方应用</div><img style='width: 80%;' id='imagesdfgg'></div>"
					);
				}
